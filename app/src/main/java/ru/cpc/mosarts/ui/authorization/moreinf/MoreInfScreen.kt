    ...
    LaunchedEffect(Unit) {
        ...
        viewModel.event.collect {
            when (it) {
                ...
                MoreInfScreenEvent.GoToTest -> navigator.navigateWithClearBackStack(
                    ThemesScreenDestination
                )
            }
        }
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            FormTextField(
                ...
                label = {
                    Text(text = stringResource(id = R.string.name).require())
                },
            ...
            FormTextField(
                ...
                label = {
                    Text(text = stringResource(id = R.string.surname).require())
                },
...
private fun String.require() = buildAnnotatedString {
    withStyle(
        style = SpanStyle(
            color = Black,
        )
